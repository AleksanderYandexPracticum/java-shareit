...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    item_id     BIGINT            NOT NULL CONSTRAINT bookings_items_fkey REFERENCES items ON UPDATE CASCADE,
    booker_id   BIGINT            NOT NULL CONSTRAINT bookings_users_fkey REFERENCES users ON UPDATE CASCADE,
